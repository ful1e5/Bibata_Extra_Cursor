...
install() {
  ...
  # Copying files
  cp -rf $Bibata_Dark_Red $DEST_DIR
  cp -rf $Bibata_Dodger_Blue $DEST_DIR
  cp -rf $Bibata_Pink $DEST_DIR
  cp -rf $Bibata_Turquoise $DEST_DIR
...
remove() {
  ...
  if [[  -d $DEST_DIR/Bibata_Dark_Red || -d $DEST_DIR/Bibata_Dodger_Blue || -d $DEST_DIR/Bibata_Pink || -d $DEST_DIR/Bibata_Turquoise ]]; then
  ...
  # Removing files
  rm -rf $DEST_DIR/Bibata_Dark_Red
  rm -rf $DEST_DIR/Bibata_Dodger_Blue
  rm -rf $DEST_DIR/Bibata_Pink
  rm -rf $DEST_DIR/Bibata_Turquoise
...
ROOT_UID=0
DEST_DIR=
Bibata_Dark_Red=./Bibata_Dark_Red/out/X11/Bibata_Dark_Red 
Bibata_Dodger_Blue=./Bibata_Dodger_Blue/out/X11/Bibata_Dodger_Blue
Bibata_Pink=./Bibata_Pink/out/X11/Bibata_Pink
Bibata_Turquoise=./Bibata_Turquoise/out/X11/Bibata_Turquoise
